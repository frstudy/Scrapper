...
cities=cfg.cities
engine = create_engine('mysql+pymysql://{}:{}@{}:{}/{}'.format(cfg.mysql['user'], cfg.mysql['password'], cfg.mysql['host'], cfg.mysql['port'],cfg.mysql['db']),
					 echo=False
					 )
...
def justdial():
	...
	l=list(lnk['links'])
	# Looping through all the cities and categories
	for city in cities:
